...
class	DocumentFile
{
	...
	private:
		...
		set<string> excluded_words; // store exclusions
};
...
class	DocumentIndex
{
	...
	private:
		...
		map<string,vector<int>> index ; //contains vector<int> since Main has vector<int> for page numbers

		map<string,int> num_occurrences; // just for checking number of appearances
